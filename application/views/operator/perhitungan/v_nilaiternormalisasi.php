			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-7 align-self-center">
						<h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Daftar Data Vektor Bobot Ternormalisasi (W)
						</h4>
						<!-- ini v_breadcrumb -->
					...
					<div class="col">
						<div class="card">
							<div class="card-header text-white bg-light">
								<a class="text-info"><i class="fas fa-database"></i>&nbsp Tahap Kelima </a>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered">
										...
										<tbody class="text-center">
											<?php 
											$w="W";
											foreach ($hasil_ternormalisasi as $data_ternormalisasi): ?>
											<tr>
												<td>
													<?php echo $w.substr($data_ternormalisasi->id_w, 1, 3) ?>
												</td>
												<td>
													<?php echo $data_ternormalisasi->nilai_w ?>
												</td>
											</tr>
											<?php endforeach; ?>
										</tbody>
